...
export class IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dashboardService
      .ObterDadosAnuaisPeloUsuarioId(this.usuarioId, this.anoAtual)
      .subscribe((resultado) => {
  ...
  CarregarDados(anoSelecionado: number): void {
    this.dashboardService
      .ObterDadosAnuaisPeloUsuarioId(this.usuarioId, anoSelecionado)
      .subscribe((resultado) => {
        this.labels = this.RetornarMeses(resultado.meses);
